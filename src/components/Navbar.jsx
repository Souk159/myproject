    ...
    <nav className='bg-black text-white px-8 md:px-16 lg:px-24'>
        <div className='container py-2 flex justify-center md:justify-between items-center'>
            ...
            <div className='space-x-6'>
                <a href='#home' className='hover-gray-400'>Home</a>
                <a href='#about' className='hover-gray-400'>About me</a>
                <a href='#service' className='hover-gray-400'>Service</a>
                <a href='#project' className='hover-gray-400'>Project</a>
                <a href='#contact' className='hover-gray-400'>Connect</a>
            </div>
